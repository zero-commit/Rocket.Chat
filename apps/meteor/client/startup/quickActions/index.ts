import { QuickActionsEnum, quickActions } from '../../lib/QuickActions';

quickActions.add(QuickActionsEnum.MoveQueue, {
	groups: ['live'],
...
quickActions.add(QuickActionsEnum.ChatForward, {
	groups: ['live'],
...
quickActions.add(QuickActionsEnum.Transcript, {
	groups: ['live'],
...
quickActions.add(QuickActionsEnum.CloseChat, {
	groups: ['live'],
